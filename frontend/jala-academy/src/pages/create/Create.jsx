...
const Create = () => {
  ...
  const countries =['-Select Country-','Bangladesh', 'Canada' ,'China', 'France','India' ,'Japan', 'Nepal', 'Sri iLanka' , 'UK','USA'];
  const Cities ={
    '-Select Country-':['-Select City'],
    'Bangladesh' :['Dhaka','Chattogram','	Gazipur','Narayanganj','Khulna','Rangpur'],
     'Canada' :['Alberta','Banff',' Brooks',' Calgary',' Edmonton',' Fort McMurray',' Grande Prairie',' Jasper'] ,
     'China':['Hong Kong','Macau','Beijing','Chongqing','Anqing','Fuyang'],
      'France':['Paris','Marseille','Lyon','Nantes','Montpellier','Colombes','Le Tampon'],
      'India' :['Pune','Nagpur',"Mumbai",'Bhopal',"Hydrabad",'Chennai','Delhi','Kolkata'],
      'Japan':['Akashi','Funabashi','Fukui','Gifu','Tokyo'],
       'Nepal':['Kathmandu','Lalitpur','Ghorahi','Dhangadhi'],
        ...
        'UK':['London','Westminster','Leeds','Birmingham','Bradford','Manchester'],
  ...
  //console.log(selectedCountry);
    ...
    const defaultAppData = {
     ...
     const[allEmployee , setAllEmployee] = useState({});
      ...
      async function load(){
        const result = await axios.get("http://localhost:8086/api/v1/employee/getAll");
    ...
    <div className="w-full h-max">
      <AppContext.Provider value={{ appData, setAppData }}>
        ...
        <div className="flex">
          ...
          <h2 className="text-base font-bold leading-7 text-gray-900 text-xl">Employee Details</h2>

        <div className='text-black flex justify-end mb-2'>
        <FaHome className='mt-1 mr-1'/><h1 className='text-base font-bold leading-7 text-gray-530 '> Home / Employee / create </h1>
        </div>
<hr />

              <Link to={"/search"}>
                <button type="button" className="btn btn-primary my-2 p-2">Employee List</button>
      ...
      <div className="space-y-12 text-gray-900 my-4 border-solid border-1 border-indigo-400 px-4 py-1">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-2 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-3">
              <label htmlFor="m-number" className="block text-sm font-medium leading-6 text-gray-900">
                Mobile number
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="sm:col-span-3">
              <label htmlFor="b-date" className="block text-sm font-medium leading-6 text-gray-900">
                Date of birth
              </label>
              <div className="mt-2">
                <input
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-4 space-y-2 flex  gap-0.1">
                <div>
                <legend className="text-sm m-2.5 font-semibold text-gray-900">Gender:</legend>             

                </div>

                <div className="flex items-center gap-x-2">
                  
                  <label htmlFor="pushRadio" className="block text-sm font-medium leading-6 text-gray-900">
                  <input
                    id="gender"
                    name="gender"
                    value="Male"
            ...
            <div className="sm:col-span-2">
              ...
              {
                  selectedCountry &&  !checked && <select
                  id="country"
                  name="country"
                  autoComplete="country-name"
                  value={city}
            ...
            <div className="px-8 py-2 col-span-full">
                <div className=" m-2 ">
                    ...
                    <label htmlFor="first" className="ms-2 text-sm font-medium">
                          Middleware
                      </label>
                </div>
                <div className=" m-2">
                    <input  id="second" type="checkbox" 
                          className="w-4 h-4 text-blue-800  
                                  focus:ring-red-500 focus:ring-2"/>
                    <label htmlFor="second" className="ms-2 text-sm font-medium">
                         AWS
                      </label>
                </div>
                <div className="m-2">
