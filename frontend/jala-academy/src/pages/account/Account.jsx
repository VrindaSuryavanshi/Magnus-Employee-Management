...
const Account = () => {
  ...
  {
       isLog ? (<Home logoutFn={logoutFn}/>) :(<div
    ...
    >
      <div className="d-flex justify-content-center  flex-column mb-1 gap-2 details-container p-2">
        <h2 style={{ fontSize: "35px", fontWeight: "700" }}>JALA Academy</h2>
        <h3>Use the bellow details to log in</h3>
        <p>Email : training@jalaacademy.com</p>
        <p>Password : jobprogram</p>

        <strong>
          <mark>Learn everything on Real-Time Scenarios. FREE for all.</mark>
        </strong>
      </div>
      ...
      <form action="">
        <div className="acoount-container">
          ...
          <div className="sign-button">
            {/* <Link to={"/home"}>  */}
            <button type="button" className="btn btn-primary text-black bg-blue-400" onClick={handelSignIn}>
              Sign In
            </button>
            {/* </Link> */}
      ...
      <div className="footer-container ">
        <footer>
          <p>
            ...
            <a href="https://jalaacademy.com/" style={{ cursor: "pointer" }}>
