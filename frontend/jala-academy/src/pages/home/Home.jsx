            ...
            <div className="my-20 m-2">
                  <h1 className="text-4xl my-4">Welcome to JALA Academy</h1>
                    ...
                    <p>The world's best up-skilling academy</p>
                      ...
                      <strong>Do you want to learn Selenium/cucumber Automation completely with Practical Scenarios in 7 Days? Use this website to find all the scenarios at one place.
                      ...
                      <div className="my-4 border-t-4 border-indigo-400 bg-gray-100 text-black p-4 ">
                          <p>You learn Everything by doing projects if you are very serious to gat a software job in 90 days  <a className="text-blue-600" href="http://jalatechnologies.com"> http://jalatechnologies.com</a> 
                             <br /> Don't forget to read our website JALA Academy completley to know more opportunities</p>
                      </div>
