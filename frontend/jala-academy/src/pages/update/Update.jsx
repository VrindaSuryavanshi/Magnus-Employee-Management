  ...
  //console.log(selectedCountry);
    ...
    const defaultAppData = {
     ...
     const[updateEmployee , setUpdateEmployee] = useState('');
      ...
      async function load(){
        const result = await axios.get("http://localhost:8086/api/v1/employee/search/" + _id);
    ...
    <div className="w-full h-max">
      <AppContext.Provider value={{ appData, setAppData }}>
        ...
        <div className="flex">
          ...
          <h2 className="text-base font-bold leading-7 text-gray-900 text-xl">Employee Update</h2>

        <div className='text-black flex justify-end mb-2'>
        <FaHome className='mt-1 mr-1'/><h1 className='text-base font-bold leading-7 text-gray-530 '> Home / Employee / update </h1>
        </div>
<hr />
