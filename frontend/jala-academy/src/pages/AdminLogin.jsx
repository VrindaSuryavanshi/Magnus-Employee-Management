...
<hr />
<form  onSubmit={handleOnclick} className="max-w-sm mt-10 mx-auto p-4 border-solid border-1 border-indigo-300 ">
    <p className='text-center mb-4'>Admin - Sign in</p>
  <div className="mb-5">
    <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-1000 ">
        Admin email</label>
    <input type="email" id="email" value={email} onChange={(e)=>setEmail(e.target.value)}
     className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@flowbite.com" required />
  </div>
  <div className="mb-5">
    <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-1000 ">Admin password</label>
  ...
  <Link to={"/"}>
  <button type="button" class="btn btn-primary mr-2 text-black">Back</button>
  </Link>
