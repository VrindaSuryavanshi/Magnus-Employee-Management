    ...
    return(
      ...
      <AppContext.Provider value={{ appData, setAppData }}>
        ...
        <div className="flex">
          ...
          <h2 className="text-base font-bold leading-7 text-gray-900 text-xl">Slider</h2>
         
          <div className='text-black flex justify-end mb-2'>
           <FaHome className='mt-1 mr-1'/><h1 className='text-base font-bold leading-7 text-gray-530 '> Home / More / Slider</h1>
        </div>
                    ...
                    <Tabs
                        ...
                        >
                            ...
                            <Tooltip title={`current value : ${value}`} arrow>
                                ...
                                <input id="pi_input" type="range" min="0" max="100" step="any" onChange={ handleInput}
                              className='text-gray-900 w-full'/>
                                </Button>
                            </Tooltip>
                             
                            <p className='m-6'>Value: <output id="value" value={value} >{value}</output></p>
