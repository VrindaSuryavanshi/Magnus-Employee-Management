    ...
    <div className="w-full h-full">
      <AppContext.Provider value={{ appData, setAppData }}>
        ...
        <div className="flex">
          ...
          <h2 className="text-base font-bold leading-7 text-gray-900 text-xl">Mutliple Tabs</h2>
         
          <div className='text-black flex justify-end mb-2'>
           <FaHome className='mt-1 mr-1'/><h1 className='text-base font-bold leading-7 text-gray-530 '> Home / More / Mutiple tabs </h1>
        </div>
          ...
          <Tabs
              ...
              >
                <Tab eventKey="Plan to Succeed" title="Plan to Succeed" >
                 <p>
                 Congratulations, You are in the best place to learn the technologies for JOB. Please strictly follow the plan for the first 45 days to see the unbelievable results.<br/>
                 <br/>
