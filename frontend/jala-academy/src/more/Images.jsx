    ...
    <div className="w-full h-full">
      <AppContext.Provider value={{ appData, setAppData }}>
        ...
        <div className="flex">
          ...
          <h2 className="text-base font-bold leading-7 text-gray-900 text-xl">Images download/uplaod</h2>
         
          <div className='text-black flex justify-end mb-2'>
           <FaHome className='mt-1 mr-1'/><h1 className='text-base font-bold leading-7 text-gray-530 '> Home / More / </h1><p className="p-1">Images download/uplaod</p>
        </div>
<hr  className="text-black"/>
          <div className="flex flex-row gap-4">

          <div className="mb-3 basis-1/2">
            <label htmlFor="images" className=" text-black form-label my-6 text-bold">Select Image file :</label>
            <input className="form-control w-[100%] " type="file" id="formFileMultiple" name="images"
      onChange={onSelectFile}
        ...
        <div className="mb-3 basis-1/4">
            <label htmlFor="formFileMultiple" className=" text-black form-label my-6 text-bold"> Image file :</label>
            <input className="form-control w-[100%]  " type="text" id="formTextFile" value={fileName} />
        </div>
        ...
        <button type="button" className="btn btn-success " onClick={handleUpload}>Upload</button>
          ...
          <h5 className="text-black">List Of Images : </h5><br />
          <div className="images grid grid-flow-row-dense grid-cols-4 grid-rows-3 gap-y-2">
            {
              ...
              upload.map((image , index)=>{
                return(
                  ...
                  <a href={selectedIamges}><img src={image} style={{ width : "300px" ,height:"200px"}}/></a>  
                    <button className="text-red-700 w-fit h-fit bg-red-400 m-2 rounded-m" onClick={
                      ()=>{
