...
const Collapsible = () => {
  ...
  const handleTooltipClose = () => {
    ...
    setOpen(false);
   setLabel("You have not clicked this BUTTON yet. Please Click me and check the tooltip!");
  };
    ...
    <div className="w-full h-full">
      <AppContext.Provider value={{ appData, setAppData }}>
        ...
        <div className="flex">
          ...
          <h2 className="text-base font-bold leading-7 text-gray-900 text-xl">Tooltips</h2>
         
          <div className='text-black flex justify-end mb-2'>
           <FaHome className='mt-1 mr-1'/><h1 className='text-base font-bold leading-7 text-gray-530 '> Home / More / Tooltips</h1>
        </div>
            ...
            <div>
              <Tooltip
               ...
               // title={label}
                arrow
              >
                <Button className="bg-blue-200 text-white" onClick={handleTooltipOpen}>Check The Tooltip Before You Click!</Button>
              </Tooltip>
            </div>
          </ClickAwayListener>
