    ...
    <div className="w-full h-full">
      <AppContext.Provider value={{ appData, setAppData }}>
        ...
        <div className="flex">
          ...
          <h2 className="text-base font-bold leading-7 text-gray-900 text-xl">Menu</h2>
         
          <div className='text-black flex justify-end mb-2'>
           <FaHome className='mt-1 mr-1'/><h1 className='text-base font-bold leading-7 text-gray-530 '> Home / More / Menu </h1>
        </div>
<hr  className="text-black"/>
          ...
          <div className="grid grid-cols-2 gap-10 content-between text-center text-green-900">
              ...
              <div className="flex gap-2">
                <h6>Your selected value is : </h6>    <h6 className="text-green-900 mr-10" id="selectedValue">Not selcted</h6>
